...
7. If you're using `attrs({})` and some of the attributes you pass to are functions, it's recommended to switch to the new `attrs(props => ({}))` syntax instead for easier and more powerful composition.
